...
$english = array(
    ...
    'importer:send_invites' => 'Send invitations',
    'importer:address_book' => 'Import address book',
    'importer:personal_note' => 'Personal note: ',
    'importer:your_contacts' => 'Your contacts',
    'importer:no_invite_contacts' => 'You haven\'t selected any contacts to invite yet...',
    'importer:login_failed' => "Login failed: ensure the email & password you have provided are correct.",
    'importer:unable_get_contacts' => "Unable to retreive any email contacts!",
    'importer:no_contacts' => "You do not have any contacts in your address book.",
    'importer:email_missing' => "Login failed: you need to enter a valid email address.",
    'importer:password_missing' => "Login failed: you need to enter a valid password.",
    'importer:email_provider_missing' => "Login failed: you need to choose a webmail service provider.",
    'importer:inviter_missing' => 'Inviter information missing...',
    'importer:no_session' => 'No active session...',
    'importer:message_missing' => 'Message missing...',
    'importer:invite' => 'Invite?',
    'importer:name' => 'Name',
